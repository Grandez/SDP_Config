...
INSERT INTO RUL_GROUPS (idGroup, idParent, activo, idName)  VALUES (   0,  0, 1, 'ROOT');
INSERT INTO RUL_DESC   (cdgMsg, idLang, idDialect, msg)     VALUES (   0, 'XX', 'XX', 'Raiz');

INSERT INTO RUL_GROUPS (idGroup, idParent, activo, idName)  VALUES (   1,  0, 1, 'SOURCE');
INSERT INTO RUL_DESC   (cdgMsg, idLang, idDialect, msg)     VALUES (   1, 'XX', 'XX', 'Codigo fuente');

INSERT INTO RUL_GROUPS (idGroup, idParent, activo, idName)  VALUES (  11,  1, 1, 'COMMENT');
INSERT INTO RUL_DESC   (cdgMsg, idLang, idDialect, msg)     VALUES (  11, 'XX', 'XX', 'Comentarios');

INSERT INTO RUL_ITEMS  (idGroup, idItem,  activo, keyNum, keyTxt, uid, tms) VALUES ( 11,  1101, 1, 0, 'D', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT INTO RUL_ISSUES (idItem,  idIssue, activo, severity, tipo, comparador,  valor, uid, tms) 
                VALUES (  1101,   110101,      1,        1,    1,          0,    'D', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT INTO RUL_DESC   (cdgMsg, idLang, idDialect, msg) VALUES (  100101, 'XX', 'XX', 'No usar codigo de depuracion');

INSERT INTO RUL_ITEMS  (idGroup, idItem,  activo, keyNum, keyTxt, uid, tms) VALUES ( 11,  1102, 1, 0, '/', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT INTO RUL_ISSUES (idItem,  idIssue, activo, severity, tipo, comparador,  valor, uid, tms) 
                VALUES (  1102,   110201,      1,        1,    1,          0,    '/', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT INTO RUL_DESC   (cdgMsg, idLang, idDialect, msg) VALUES (  100102, 'XX', 'XX', 'Usar solo caracter asterisco para comentarios');


INSERT INTO RUL_GROUPS (idGroup, idParent, activo, idName)  VALUES (  12,  1, 1, 'SYMBOLS');
INSERT INTO RUL_DESC   (cdgMsg, idLang, idDialect, msg)     VALUES (  12, 'XX', 'XX', 'Simbolos y caracteres especiales');

INSERT INTO RUL_ITEMS  (idGroup, idItem,  activo, keyNum, keyTxt, uid, tms)              VALUES ( 12   ,  12001   , 1, 0, '-', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT INTO RUL_ISSUES (idItem,  idIssue, activo, severity, tipo, comparador,  valor, uid, tms) 
                VALUES (  1201,   120101,      1,        2,    1,          1,    '-', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT INTO RUL_DESC   (cdgMsg, idLang, idDialect, msg) VALUES (  120101, 'XX', 'XX', 'No dividir el literal en varias lineas');

INSERT INTO RUL_ITEMS  (idGroup, idItem,  activo, keyNum, keyTxt, uid, tms)              VALUES ( 12   ,  12002   , 1, 0, ' ', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT INTO RUL_ISSUES (idItem,  idIssue, activo, severity, tipo, comparador,  valor, uid, tms) 
                VALUES (  1202,   120201,      1,        4,    1,          1,    ' ', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT INTO RUL_DESC   (cdgMsg, idLang, idDialect, msg) VALUES (  1200102, 'XX', 'XX', 'No usar caracteres no imprimibles');


INSERT INTO RUL_ITEMS  (idGroup, idItem,  activo, keyNum, keyTxt, uid, tms) VALUES (  12,  1203, 1, 0, 'EJECT', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT INTO RUL_ISSUES (idItem,  idIssue, activo, severity, tipo, comparador,   valor, uid, tms) 
                VALUES (  1203,   120301,      1,        3,    1,          1,    'EJECT', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT INTO RUL_DESC   (cdgMsg, idLang, idDialect, msg) VALUES (  120301, 'XX', 'XX', 'No es necesario imprimir el codigo');

INSERT INTO RUL_ITEMS  (idGroup, idItem,  activo, keyNum, keyTxt, uid, tms) VALUES (  12,  1204, 1, 0, 'SKIP', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT INTO RUL_ISSUES (idItem,  idIssue, activo, severity, tipo, comparador,   valor, uid, tms) 
                VALUES (  1204,   120401,      1,        3,    1,          1,    'SKIP', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT INTO RUL_DESC   (cdgMsg, idLang, idDialect, msg) VALUES (  120401, 'XX', 'XX', 'No es necesario imprimir el codigo');

INSERT INTO RUL_ITEMS  (idGroup, idItem,  activo, keyNum, keyTxt, uid, tms) VALUES (  12,  1205, 1, 0, 'DIRECTIVE', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT INTO RUL_ISSUES (idItem,  idIssue, activo, severity, tipo, comparador,   valor, uid, tms) 
                VALUES (  1205,   120501,      1,        3,    1,          1,    'DIRECTIVE', 'SYSTEM', CURRENT_TIMESTAMP);
INSERT INTO RUL_DESC   (cdgMsg, idLang, idDialect, msg) VALUES (  120501, 'XX', 'XX', 'No se pueden usar directivas de compilacion en el codigo');
...
-- 
-- INSERT INTO RUL_ITEMS       (idGroup, idItem,  activo, keyNum, keyTxt, uid, tms) VALUES (   1,  1002, 1, 0, 'TAB', 'SYSTEM', CURRENT_TIMESTAMP);
-- INSERT INTO RUL_ISSUES      (idItem,  idIssue, activo, severity, comparador, tipo, valor, uid, tms) VALUES ( 1002, 1, 1, 4, 1'', 'SYSTEM', CURRENT_TIMESTAMP);
-- INSERT INTO RUL_DESC (cdgMsg, idLang, idDialect, msg) VALUES (   100201, 'XX', 'XX', 'No usar caracteres tabulacion');
-- 
-- 
